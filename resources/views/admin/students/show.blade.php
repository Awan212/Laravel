<div class="table-responsive">
  <table class="table table-bordered table-hover table-sm table-all-student-list" id="dataTable">
    <thead>
      <tr>
        <th scope="col">#</th>
    ...
    <tbody>
      ...
      <tr scope="row">
        ...
        <td class="noprint">
          <a href="student_card?student={{ $student->id }}" target="_blank" class="btn btn-primary card-print">Print</a>
        </td>
